...
//
//    public static final DeferredRegister<VillagerProfession> PROFESSIONS = DeferredRegister.create(Vanity.MOD_ID, Registry.VILLAGER_PROFESSION_REGISTRY);
//    public static final DeferredRegister<PoiType> POI_TYPES = DeferredRegister.create(Vanity.MOD_ID, Registry.POINT_OF_INTEREST_TYPE_REGISTRY);
//
//    public static final RegistrySupplier<PoiType> STYLIST_POI = POI_TYPES.register("stylist", () -> PoiTypes.registerBlockStates(new PoiType(Vanity.MOD_ID + ":stylist", ImmutableSet.<BlockState>builder().addAll(VanityBlocks.STYLING_TABLE.get().getStateDefinition().getPossibleStates()).build(), 1, 1)));
//    public static final RegistrySupplier<VillagerProfession> STYLIST = PROFESSIONS.register("stylist", () -> new VillagerProfession(Vanity.MOD_ID + ":stylist", STYLIST_POI.get(), ImmutableSet.of(), ImmutableSet.of(), VanitySounds.UI_STYLING_TABLE_TAKE_RESULT.get()));
//
