...
import tech.thatgravyboat.vanity.common.item.ConceptArtItem;
...
public class VanityItems {
    ...
    public static final Supplier<Item> CONCEPT_ART = ITEMS.register("concept_art", () -> new ConceptArtItem(new Item.Properties().stacksTo(1)));
